...
public class SirenCommandServiceImpl implements SirenCommandService {
    ...
    @Override
    public Long createSiren(SirenCreateDto sirenWriteDto,
    ...
    @Override
    public Long createSirenByUsername(SirenCreateDto sirenWriteDto, List<MultipartFile> multipartFiles,
                                      String username) {
    ...
    private Siren buildSiren(SirenCreateDto sirenWriteDto) {
        ...
        Siren build = Siren.builder()
                ...
                .petBreed(sirenWriteDto.getPetBreed())
    ...
    private Siren buildSiren(SirenCreateDto sirenWriteDto, String username) {
